...
| 协议类型 | 接入地址（Base URL） |
|---------|-------------------|
| OpenAI 兼容协议 | ` + "`http://192.168.0.27:8080/api/openai/v1`" + ` |
| Anthropic 协议 | ` + "`http://192.168.0.27:8080/api/anthropic`" + ` |
...
运行以下命令配置 CodeMind：
	...
	claude config set anthropic_base_url http://192.168.0.27:8080/api/anthropic/v1
...
4. 在 **Override OpenAI Base URL** 中，将默认 URL 替换为：http://192.168.0.27:8080/api/openai/v1
...
- **Base URL**: http://192.168.0.27:8080/api/openai/v1
...
- **Base URL**：输入 http://192.168.0.27:8080/api/openai/v1
  ...
  "customModels": [
    {
      ...
      "baseUrl": "http://192.168.0.27:8080/api/anthropic",
      "apiKey": "your_api_key",
      "provider": "anthropic",
  ...
  "customModels": [
    {
      ...
      "model": "qwen3.5-35b-a3b",
      "baseUrl": "http://192.168.0.27:8080/api/openai/v1",
      "apiKey": "your_api_key",
...
` + "```json\n" + `{
  "providers": {
    "codemind": {
      ...
      "base_url": "http://192.168.0.27:8080/api/openai/v1",
...
2. 填写以下必要的配置：
   - **Base URL**: http://192.168.0.27:8080/api/anthropic
   - **API Key**: 您的 CodeMind API Key
   - **Model**: 选择 qwen3.5-35b-a3b
...
3. 变更 API 地址为：http://192.168.0.27:8080/api/openai/v1/
...
2. **添加/替换 OpenAI Base URL 为：http://192.168.0.27:8080/api/openai/v1**
